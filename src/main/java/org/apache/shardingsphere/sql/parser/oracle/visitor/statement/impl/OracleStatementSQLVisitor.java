...
public abstract class OracleStatementSQLVisitor extends OracleStatementBaseVisitor<ASTNode> {
    ...
    private BinaryOperationExpression createBinaryOperationExpressionFromLike(final PredicateContext ctx) {
        ...
        for (SimpleExprContext each : ctx.simpleExpr()) {
            ASTNode visit = visit(each);
            //edit by ly org.apache.shardingsphere.sql.parser.sql.common.value.parametermarker.ParameterMarkerValue
            // cannot be cast to org.apache.shardingsphere.sql.parser.sql.common.segment.dml.expr.ExpressionSegment
            if(visit instanceof  ExpressionSegment){
